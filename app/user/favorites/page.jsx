  ...
  return (
    <div>
        <div className="container py-5">
            <h2 className='text-[25px] text-[#191C1F] font-medium mb-4'>Favorites</h2>
            <div className="sale my-4">
                <button className='text-white bg-[#191C1F] rounded-tr-[20px] rounded-br-[20px] w-fit px-4 py-3 border-none'>Properties for rent</button>
                <div className="flex items-center justify-between py-5">
                    <p className='text-[#191C1F] text-sm font-normal'>1 - 3 out of 3</p>
                    ...
                    <div className="card">
                        <div className="upper-img relative">
                            ...
                            <div className="reaction w-full px-5 absolute top-4 left-0 flex justify-end z-100">
                                <img src="/images/heart-fill.svg" width='21px' height='18px' alt="" />
                            </div>
                        </div>
            ...
            <div className="sale my-4">
                <button className='text-white bg-[#191C1F] rounded-tr-[20px] rounded-br-[20px] w-fit px-4 py-3 border-none'>Properties for sell</button>
                <div className="flex items-center justify-between py-5">
            ...
            <div className="sale my-4">
                <button className='text-white bg-[#191C1F] rounded-tr-[20px] rounded-br-[20px] w-fit px-4 py-3 border-none'>Properties for short term rent</button>
                <div className="flex items-center justify-between py-5">
                    <p className='text-[#191C1F] text-sm font-normal'>1 - 1 out of 1</p>
                    <select name="" id="" className='rounded-full border border-[#E9ECEF] h-[30px] w-[120px] outline-none bg-white'></select>
                </div>
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2">
                    <div className="card">

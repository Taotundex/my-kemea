      ...
      {/* <div className="container"> */}
        <main className="font-primary text-text-color">
            ...
            <div className="flex flex-col gap-[15px] py-[20px] container">
                <h2 className="text-[35px] text-[#191C1F] font-medium font-font-spring" >New Projects</h2>
            </div>
              ...
              <div className="grid lg:gap-6 md:gap-4 gap-2 lg:grid-cols-4 md:grid-cols-3 grid-cols-2">
                  <div className="card">
                    <div className="upper-img relative">
                      <Link href='new-projects/description' className="img">
                      ...
                      <div className="reaction w-full px-5 absolute top-4 left-0 flex justify-between z-100">
                        <small className="text-white bg-[#1dbf73] px-3 py-1.5 text-xs rounded-xl">Sale</small>

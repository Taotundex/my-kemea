...
import RentHomeProperty from "../my-components/RentHomeProperty"
    ...
    <main className="transition-all font-primary text-text-color">
      ...
      <div className="container font-font-spring">
        ...
        <div className="products py-5">
          {/* <div className="flex justify-between items-center gap-[10px] text-[13px]"> */}
            <div className="flex flex-wrap gap-[10px] text-[13px]">
              ...
              <div className="flex items-center">
                <Link href='/' className="h-[45px] w-[60px] flex items-center justify-center  bg-white border border-[#191C1F] text-[#191C1F] rounded-s-full">Buy</Link>
                <Link href='' className="h-[45px] w-[60px] flex items-center justify-center  bg-[#191C1F] border border-[#191C1F] text-white rounded-e-full">Rent</Link>
              </div>

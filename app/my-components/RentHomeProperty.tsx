...
const PropertyView = () => {
  ...
  // Define a state variable to track whether the heart is filled or not
    ...
    <div className="card">
      <div className="upper-img relative">
        <div className="w-full carousel rounded-box">
          <Link href="/rent/description" className="carousel-item w-full img">
            <img
              src="/images/property-img.png"
              width="100%"
              className="rounded-[12px] size-full"
              alt=""
            />
          </Link>
          <Link href="/rent/description" className="carousel-item w-full img">
          ...
          <div className="reaction cursor-pointer w-full px-5 absolute top-4 left-0 flex justify-end z-100" onClick={handleClick} >
            <svg
              width="24"
              height="20"
              viewBox="0 0 24 20"
            ...
            >
              <path
                ...
                fill={isFilled ? "#0666EB" : "black"}
                fillOpacity={isFilled ? "1" : "0.5"}
                stroke="white"
                strokeWidth="1.5"
              />
            </svg>
